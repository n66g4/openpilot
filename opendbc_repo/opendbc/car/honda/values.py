...
class CAR(Platforms):
  ...
  HONDA_NEW_FIT_CHN = HondaBoschPlatformConfig(
    ...
    CarSpecs(mass=2644 * CV.LB_TO_KG, wheelbase=2.53, steerRatio=13.6, centerToFrontRatio=0.39, tireStiffnessFactor=0.75),
    {Bus.pt: 'honda_civic_ex_2022_can_generated'},
    flags=HondaFlags.BOSCH_RADARLESS,
  )
...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  non_essential_ecus={
    Ecu.eps: [CAR.ACURA_RDX_3G, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC_2022, CAR.HONDA_E, CAR.HONDA_HRV_3G, CAR.HONDA_NEW_FIT_CHN, *HONDA_BOSCH_CANFD],
    Ecu.vsa: [CAR.ACURA_RDX_3G, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC, CAR.HONDA_CIVIC_BOSCH, CAR.HONDA_CIVIC_2022, CAR.HONDA_CRV_5G, CAR.HONDA_CRV_HYBRID,
              CAR.HONDA_E, CAR.HONDA_HRV_3G, CAR.HONDA_INSIGHT, CAR.HONDA_NEW_FIT_CHN, *HONDA_BOSCH_CANFD],
  },
  extra_ecus=[
